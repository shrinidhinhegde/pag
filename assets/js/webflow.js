...
! function (t) {
	...
	window.tram = function (t) {
		...
		var M = e.frame = function () {
			...
			j = l(function (e) {
				...
				function h(t, e, i) {
					var o, a, s, u, c = e !== p,
						l = {};
					for (o in t) s = t[o], o in K ? (l.transform || (l.transform = {}), l.transform[o] = s) : (g.test(o) && (o = n(o)), o in Z ? l[o] = s : (u || (u = {}), u[o] = s));
					for (o in l) {
		...
		R.transform && (Z.transform = [F], K = {
			...
			skewX: [k],
			skewY: [k]
		}), R.transform && R.backface && (K.z = [x, "translateZ"], K.rotateZ = [k], K.scaleZ = [w], K.perspective = [y]);
		var Q = /ms/,
			J = /s|\./;
		return t.tram = e
	}(window.jQuery)
	...
	n(5), n(8), n(9), n(10), n(11), n(16), t.exports = n(18)
}, function (t, e, n) {
	"use strict";
	var i = n(0);
				...
				! function (e, n) {
					...
					function E(t) {
						var i = t.responseJSON && t.responseJSON.msg,
							r = y;
						"string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = w), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, C() || x(n)
					}
		...
		function O(n, i) {
			...
			c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), S(a), s ? (T(a), a.el.on("setting" + m, function (t) {
				return function (n, i) {
					i = i || {};
					var r = f.width();
					S(t), !0 === i.open && q(t, !0), !1 === i.open && F(t, !0), t.open && e.defer(function () {
						r !== f.width() && R(t)
					})
				}
			}(a))) : (! function (e) {
		...
		function k(e, n) {
			...
			if (s !== e.current) {
				...
				var b = window.scrollX,
					y = window.scrollY;
				u.focus(), window.scrollTo(b, y), w.length && r.outro ? (w.each(m.outro), a(w).add("opacity " + r.outro + "ms " + o, {
					fallback: c
				}).start({
					opacity: 0
				}).then(function () {
